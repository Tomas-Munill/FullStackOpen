...
const App = () => {
  ...
  if (user === null) {
    return <LoginForm notification={notification} isSuccessful={isSuccessful} handleLogin={handleLogin} />
  }
  ...
  return (
    <div>
      ...
      {blogs
        ...
        .map(blog => <Blog key={blog.id} blog={blog} handleLike={handleLike} handleRemove={handleRemove} loggedUsername={user.userName}/>)}
    </div>
  )
}
