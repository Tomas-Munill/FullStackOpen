  ...
  return (
    <div style={blogStyle}>
      ...
      <div style={showWhenVisible}>
        ...
        <br />
        likes {blog.likes}
        <button onClick={giveALike(blog)} style={buttonStyle}>like</button>
        <br />
        {
        ...
        <br />
        {
          loggedUsername === blog.user.userName ? <button onClick={removeBlog(blog.id)} style={{ ...buttonStyle, backgroundColor: 'royalblue' }}>remove</button> : ''
        }
